  ...
  if (!posts || posts.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-agri-700 font-medium text-sm mb-1">Aucune publication trouvée</p>
        <p className="text-farm-400 text-xs">Soyez le premier à partager avec la communauté</p>
      </div>
    );
  }
