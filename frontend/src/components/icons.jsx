...
function Svg({ size = 16, className = '', children, strokeWidth = 2, ...rest }) {
  return (
    <svg {...baseProps} width={size} height={size} strokeWidth={strokeWidth} className={className} {...rest}>
      {children}
    </svg>
  );
}
...
export const Leaf = (p) => (
  <Svg {...p}>
    <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96a1 1 0 0 1 1.55.86C20.61 16.74 14.45 20 11 20Z" />
...
export const Cloud = (p) => (
  <Svg {...p}>
    <path d="M17.5 19a4.5 4.5 0 1 0-1.41-8.78A6 6 0 1 0 6.5 19h11z" />
  </Svg>
);
...
export const Sprout = (p) => (
  <Svg {...p}>
    ...
    <path d="M14.1 6a7 7 0 0 0-1.1 4c1.9-.1 3.3-.6 4.3-1.4 1-.9 1.7-2.2 2.7-4.2-3 0-4.7.5-5.9 1.6z" />
  </Svg>
);
...
export const Wheat = (p) => (
  <Svg {...p}>
    ...
    <path d="M20 9c.3 1.5.5 3 0 4.5-.5 1.5-1.5 3-3 4" />
    <path d="M16 17c-1 .5-2.5.7-4 0" />
  </Svg>
);
